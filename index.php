...
<section class="education">
    ...
    <form method="post">
        <button type="submit" name="add_education" class="edit-btn add_education_btn">Add Education</button>
    </form>
    ...
    <?php if (isset($_POST['add_education'])) : ?>
        <form method="post">
            <div class="edit-container">
                <input type="text" name="new_year" placeholder="Year"  required><br><br>
                <input type="text" name="new_degree" placeholder="Degree" required><br><br>
                <input type="text" name="new_university" placeholder="University" required><br><br>
...
<section class="skills">
    ...
    <form method="post">
        <button type="submit" name="add_skill" class="edit-btn add_skill_btn">Add Skill</button>
    </form>
...
<section class="Languages">
    ...
    <form method="post">
        <button type="submit" name="add_language" class="edit-btn add_language_btn">Add Language</button>
    </form>
      ...
      <div class="edit-container">
            <?php if ($_SESSION['editing']['name']) : ?>
              <form method="post">
                ...
                <button type="submit" name="save_personal" class="edit-btn">Save</button>
              </form>
            <?php else : ?>
    ...
    <section class="experience">
                    ...
                    <form method="post">
                        <button type="submit" name="add_experience" class="edit-btn add_experience_btn">Add Experience</button>
                    </form>

                    <?php if (isset($_POST['add_experience'])) : ?>
                        <form method="post">
                            <div class="edit-container">
                                <input type="text" name="new_job_position" placeholder="Job Position" required><br><br>
                                <input type="text" name="new_company" placeholder="Company Name" required><br><br>
                                <input type="text" name="new_start" placeholder="Start Year" required><br><br>
                                <input type="text" name="new_end" placeholder="End Year" required><br><br>
            ...
            <section class="project">
              ...
              <form method="post">
                  <button type="submit" name="add_project" class="edit-btn add_project_btn">Add Project</button>
              </form>

              <?php if (isset($_POST['add_project'])) : ?>
                  <form method="post">
                      <div class="edit-container">
                          <input type="text" name="new_project_name" placeholder="Project Name" required><br>
                          <input type="text" name="new_project_description" placeholder="Project Description" required><br>
                          <button type="submit" name="save_project" class="edit-btn">Save</button><br>
                      </div>
                  </form>
              <?php endif; ?>
          </section>
    ...
    <form method="post">
        <button type="submit" name="preview" class="edit-btn">Preview</button>
    </form>
</div>
    </div>
